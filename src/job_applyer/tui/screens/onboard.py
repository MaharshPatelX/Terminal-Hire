...
class OnboardScreen(Screen):
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical():
            log = RichLog(id="onboard-log", classes="chat-log", markup=True, wrap=True)
            yield log
    ...
    def on_mount(self) -> None:
        ...
        log.write("[dim]system[/]  Core facts first. Packs (citizen / OPT / STEM OPT / …) only if you enable them.")
