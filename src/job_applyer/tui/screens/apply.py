...
class ApplyScreen(Screen):
    ...
    def on_mount(self) -> None:
        ...
        log.write("[dim]system[/]  MVP never clicks Submit (APPLICATION_SUBMISSION_ENABLED=false).")
    ...
    def on_button_pressed(self, event: Button.Pressed) -> None:
        ...
        log.write("[bold cyan]apply[/]  Playwright inventory lands in M4; mapper + fill in M5.")
